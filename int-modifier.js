...
if (requestType == "Add Vehicle") {
    ...
    if (titleholder == "Parent/child at same residence") {
        ...
        $('body').append("<aside><h2>Select Client Type</h2><input type=\"radio\" id=\"costcoRadio\" name=\"clientTypeRadio\" value=\"Costco\"><label for=\"costcoRadio\"> Costco</label><input type=\"radio\" id=\"advisorRadio\" name=\"clientTypeRadio\" value=\"Advisor\"><label for=\"advisorRadio\"> Advisor</label><input type=\"radio\" id=\"progressiveRadio\" name=\"clientTypeRadio\" value=\"Progressive\"><label for=\"progressiveRadio\"> Progressive</label><h2>" + requestType + "</h2><p>Added " + vehicleYear + " " + vehicleMake + " " + vehicleModel + " effective " + effectiveDate + ".</p><button type=\"button\" id=\"copyButton\">Copy</button><button type=\"button\" id=\"emailButton\">Email</button></aside>");
...
$('#emailButton').click(function() {
    window.open("mailto:EMAIL?subject=Policy Number " + policyNumber + "&body=" + errorVehicleTitleOtherEmail);
});
